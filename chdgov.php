...
<title>Chandigarh Government Hospitals</title>
...
<p id="govhos">Top Government Hospitals in Chandigarh.</p></div>

<?php
session_start();
include('db.php');
$query="SELECT * FROM `hos_reg` where `city`='Chandigarh' && `type`='Government'";
