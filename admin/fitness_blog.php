...
function myfnx(){
	var title=document.forms['fitness_form']['title'].value;
	var blog=document.forms['fitness_form']['blog'].value;
var blen=blog.length;

	if(title==null || title==""){
document.getElementById("user_error").innerHTML="please! enter the title name";
document.forms['fitness_form']['title'].focus();
return false;
}
if(blog==null || blog=="")
{
...
?>
  ...
  <div class="form">
  <h1>Fitness Blog</h1>
  <form action="fitness_db.php"method="post" name="fitness_form" enctype="multipart/form-data" onsubmit="return myfnx()">
