...
<title>Amritsar Government Hospitals</title>
...
<p id="govhos">Top Government Hospitals in Amritsar.</p></div>
<?php
session_start();
include('db.php');
$query="SELECT * FROM `hos_reg` where `city`='Amritsar' && `type`='Government'";
...
?>
 ...
 <?php
	echo "<img src='uploads/".$row['image']."'height='150px' width='200px'/>";
