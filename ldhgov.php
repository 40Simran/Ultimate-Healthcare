...
<title>Ludhiana Government Hospitals</title>
...
<p id="govhos">Top Government Hospitals in Ludhiana.</p></div>
<?php
session_start();
include('db.php');
$query="SELECT * FROM `hos_reg` where `city`='Ludhiana' && `type`='Government'";
