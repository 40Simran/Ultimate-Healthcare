...
<div class="view_blog">
<div class="bone_image"><div class="overlay"></div></div>
<div class="heading"><h1>Skin care in Punjab </h1></div>
<div class="dental">
<?php

include("db.php");
$a="select * from `services` where `service_type`='bone'";
