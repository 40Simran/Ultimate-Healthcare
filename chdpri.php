...
<title>Chandigarh Private Hospitals</title>
...
<p id="govhos">Top Private Hospitals in Chandigarh.</p></div>
<a href="govhosp.php"><input type="button" value="BACK"/></a>

<?php
session_start();
include('db.php');
$query="SELECT * FROM `hos_reg` where `city`='Chandigarh' && `type`='Private'";
