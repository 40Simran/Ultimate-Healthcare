...
<title>Patiala Government Hospitals</title>
...
<p id="govhos">Top Government Hospitals in Patiala.</p></div>

<?php
session_start();
include('db.php');
$query="SELECT * FROM `hos_reg` where `city`='Patiala' && `type`='Government'";
